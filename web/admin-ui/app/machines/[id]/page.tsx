...
export default function MachineDetailPage({ params }: PageProps) {
  ...
  const metrics = [
    { title: "ยอดขาย", value: "฿1,458.5", color: "#0F172A" },
    { title: "คำสั่งซื้อ", value: "342", color: "#0F172A" },
    { title: "อุณหภูมิตู้", value: "65°C", color: "#0F172A" },
    ...
    <div className="max-w-[1200px] mx-auto py-8 px-4 space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              <h1 className="text-[28px] font-black text-[#0F172A]">{machine.name}</h1>
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-6 py-2.5 bg-[#1E293B] text-white rounded-xl text-[14px] font-bold shadow-[0_8px_20px_rgba(30,41,59,0.2)] hover:bg-[#0F172A] hover:-translate-y-0.5 transition-all">
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
        <h3 className="text-[18px] font-black text-[#0F172A] mb-8">กราฟยอดขาย</h3>
