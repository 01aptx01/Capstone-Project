...
export default function SalesPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      // ── ยอดวันนี้จาก dashboard summary (แหล่งเดียวกับแดชบอร์ด) ──
      setTodaySales(summary.total_sales_today);

      // ── ยอดเมื่อวาน + จำนวนออเดอร์วันนี้ จาก sales report ──
