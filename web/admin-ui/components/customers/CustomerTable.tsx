  ...
  return (
    <div className="bg-[var(--surface-1)]/40 backdrop-blur-3xl border border-[var(--border)]/60 rounded-[40px] overflow-hidden shadow-[0_32px_64px_rgba(0,0,0,0.04)] animate-in fade-in duration-700">
      <div className="px-10 py-8 border-b border-[var(--border)]/40 bg-gradient-to-b from-[var(--surface-1)]/50 to-transparent">
        <h2 className="text-[22px] font-black text-[var(--text)] tracking-tight mb-1">รายชื่อสมาชิก</h2>
        <p className="text-[var(--text-muted)] text-sm font-bold">
          ข้อมูลจาก <code className="text-xs font-mono bg-[var(--surface-2)] px-1 rounded">/api/admin/customers</code>{" "}
          (ชุดที่โหลดในหน้านี้)
        </p>
      </div>
      {error && (
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[var(--surface-2)]/40 border-b border-[var(--border)]/40">
              <th className="px-10 py-4 text-[11px] font-black text-[var(--text-muted)] uppercase tracking-widest">เบอร์โทร</th>
              <th className="px-6 py-4 text-[11px] font-black text-[var(--text-muted)] uppercase tracking-widest">แต้ม</th>
              <th className="px-6 py-4 text-[11px] font-black text-[var(--text-muted)] uppercase tracking-widest">สถานะ</th>
              <th className="px-10 py-4 text-[11px] font-black text-[var(--text-muted)] uppercase tracking-widest">สมัครเมื่อ</th>
              <th className="px-10 py-4 text-[11px] font-black text-[var(--text-muted)] uppercase tracking-widest">ใช้งานล่าสุด</th>
            </tr>
          </thead>
