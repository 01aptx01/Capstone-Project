    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-[0_25px_60px_-10px_rgba(15,23,42,0.2)] overflow-hidden border border-[#E2E8F0] animate-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 border-b border-[#F1F5F9] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#FFF7ED] rounded-xl flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f47b2a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <h2 className="text-[18px] font-black text-[#334155] tracking-tight leading-none">
                ส่งออกข้อมูล
              </h2>
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-[#F1F5F9] rounded-full transition-all text-[#94A3B8] hover:text-[#334155]"
          >
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[12px] font-bold text-[#f47b2a] hover:underline"
              >
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-2xl border-2 cursor-pointer transition-all duration-200 flex items-start gap-3 ${
                    isSelected
                      ? "border-[#f47b2a] bg-[#FFF7ED] shadow-[0_4px_20px_rgba(244,123,42,0.08)]"
                ...
                >
                  <div className={`mt-0.5 w-5 h-5 rounded-md border-2 flex-shrink-0 flex items-center justify-center transition-all ${
                    isSelected ? "bg-[#f47b2a] border-[#f47b2a]" : "border-[#CBD5E1] bg-white"
                  }`}>
                    {isSelected && (
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className={`text-[14px] font-bold transition-colors ${isSelected ? "text-[#f47b2a]" : "text-[#334155]"}`}>
                      {section.label}
                    </h3>
        ...
        <div className="px-6 py-5 bg-[#F8FAFC] border-t border-[#F1F5F9] flex items-center gap-3">
          <button
            onClick={onClose}
            className="flex-1 py-3 border-2 border-[#E2E8F0] text-[#64748B] font-bold text-[14px] rounded-xl hover:bg-white hover:text-[#334155] transition-all"
          >
            ยกเลิก
          </button>
          <button
            ...
            className="flex-[2] flex items-center justify-center gap-2 py-3 bg-[#f47b2a] hover:bg-[#d35e11] text-white rounded-xl text-[15px] font-black shadow-[0_8px_24px_rgba(244,123,42,0.3)] transition-all disabled:opacity-40 disabled:cursor-not-allowed active:scale-[0.98] hover:-translate-y-0.5"
          >
            {isExporting ? (
              <>
