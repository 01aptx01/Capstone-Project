  ...
  return (
    <div className="vibrant-card !rounded-[40px] p-8 h-full shadow-2xl shadow-orange-900/[0.03]">
      <div className="flex justify-between items-center mb-10">
        <div>
          <h3 className="text-[22px] font-black text-[var(--text)] tracking-tight mb-1">Sales by Flavor</h3>
          <p className="text-[14px] font-semibold text-[var(--text-muted)]">Popularity across flavors</p>
        </div>
      </div>
            ...
            <div className="flex justify-between items-end mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[12px] font-bold text-[var(--text-muted)] uppercase tracking-widest">{flavor.percentage}% Contribution</span>
                </div>
              </div>
