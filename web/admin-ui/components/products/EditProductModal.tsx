      ...
      <form onSubmit={handleSubmit} className="space-y-6 relative">
            ...
            <div className={`w-32 h-32 rounded-[24px] border-2 border-dashed flex flex-col items-center justify-center overflow-hidden transition-all ${
              ...
              {imagePreview ? (
                ...
                <div className="text-center px-2">
                  ...
                  <span className="text-[10px] font-bold text-[#94A3B8] group-hover:text-[#f47b2a]">แก้ไขรูปภาพ</span>
                </div>
              )}
            </div>
            <input 
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Quantity */}
            <div className="group space-y-1.5">
              <label className="text-[12px] font-black text-[#94A3B8] ml-1 uppercase tracking-[0.1em] group-focus-within:text-[#f47b2a] transition-colors">จำนวนสต็อก</label>
              <div className="relative">
                <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#f47b2a] transition-colors">
