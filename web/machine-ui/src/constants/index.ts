...
export const MAX_COUPON_CODE_LENGTH = 50; // ตรง Coupon.code ใน DB
export const PAYMENT_COUNTDOWN_SECONDS = 300; // เวลานับถอยหลังในหน้าชำระเงิน (5 นาที — สอดคล้อง Omise QR)
export const PENDING_PAYMENT_SESSION_TTL_MS = PAYMENT_COUNTDOWN_SECONDS * 1000;
...
export const PAYMENT_POLL_MAX_ATTEMPTS = 300; // จำนวนรอบสูงสุดที่จะยิงเช็คสถานะยอดชำระ (300 รอบ ≈ 5 นาที)
