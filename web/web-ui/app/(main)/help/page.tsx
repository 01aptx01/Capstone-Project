  ...
  const faqs = [
    {
      ...
      answer:
        "คุณสามารถสะสมคะแนนเพื่อแลกรับคูปองส่วนลดได้ที่หน้า 'แลกคูปอง' จากนั้นนำรหัสคูปองจากหน้า 'คูปองของฉัน' ไปสแกนหรือระบุที่ตู้ MOD PAO ในขณะทำรายการสั่งซื้อหน้าร้านเพื่อรับส่วนลดทันที",
    },
    {
    ...
    },
    {
      ...
      answer:
        "แต้มสะสม (Points) ของคุณไม่มีวันหมดอายุ สามารถเก็บบันทึกสะสมไว้เพื่อแลกรับโปรโมชันและส่วนลดพิเศษสำหรับตู้น้ำอัจฉริยะ MOD PAO ได้ตลอดเวลาครับ",
    },
  ];
